...
variables include species(Adelie, Chinstrap, and Gentoo), island, bill
...
![](p8105_hw1_yc4959_files/figure-gfm/scatterplot-1.png)<!-- --> There
are 2 missing values automatically dropped.
...
The logical variable is converted to 0 and 1, and its mean can be
calculated. The character variable cannot be directly converted to
numeric values. The factor variable converted to numeric codes based on
its level. This explains why only numeric and logical variables can have
a mean.
